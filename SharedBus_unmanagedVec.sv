...
module SharedBus(
  ...
  wire             cpu_data_interface_masked_input =
    cpu_data_interface_cyc_o & cpu_data_interface_mask;
  ...
  wire             cpu_instruction_interface_masked_grant =
    ~cpu_data_interface_masked_input & cpu_instruction_interface_masked_input;
  wire             dummy_master_mux_test_masked_grant =
    ~cpu_data_interface_masked_input & ~cpu_instruction_interface_masked_input
    & dummy_master_mux_test_masked_input;
  wire             dummy_master_mux_test2_masked_grant =
    ~cpu_data_interface_masked_input & ~cpu_instruction_interface_masked_input
    & ~dummy_master_mux_test_masked_input & dummy_master_mux_test2_cyc_o;
  wire [3:0]       maskedGrantVec =
    {dummy_master_mux_test2_masked_grant,
     dummy_master_mux_test_masked_grant,
     cpu_instruction_interface_masked_grant,
     cpu_data_interface_masked_input};
  ...
  wire [1:0]       masterSelect =
    (|maskedGrantVec)
      ? {|{dummy_master_mux_test2_masked_grant, dummy_master_mux_test_masked_grant},
         dummy_master_mux_test2_masked_grant | cpu_instruction_interface_masked_grant}
      : (|unmaskedGrantVec)
          ? {|{dummy_master_mux_test2_unmasked_grant,
               dummy_master_mux_test_unmasked_grant},
             dummy_master_mux_test2_unmasked_grant
  ...
  wire [3:0]       _GEN_4 =
    {{dummy_master_mux_test2_cyc_o},
     ...
     {cpu_instruction_interface_cyc_o},
     {cpu_data_interface_cyc_o}};
  wire             _dat_r_cond_T_2 = _GEN[masterSelect] > 32'hEFFFFFFF;
  wire             _dat_r_cond_T_4 = _GEN[masterSelect] > 32'hF0000DAB;
  wire [31:0]      dat_r =
    _GEN[masterSelect][31:28] != 4'hF
      ? main_memory_dat_o
      : _dat_r_cond_T_2 & _GEN[masterSelect] < 32'hF0000DAC
          ? led_matrix_0_dat_o
          : _dat_r_cond_T_4 & _GEN[masterSelect] < 32'hF0000DB0
              ? switches_0_dat_o
              : main_memory_dat_o;
  ...
  wire             _switches_0_stb_i_T = _GEN_3[masterSelect] & _GEN_4[masterSelect];
  always @(posedge clock) begin
    ...
    if (|maskedGrantVec) begin
      cpu_data_interface_grant <= cpu_data_interface_masked_input;
      cpu_instruction_interface_grant <= cpu_instruction_interface_masked_grant;
      dummy_master_mux_test_grant <= dummy_master_mux_test_masked_grant;
      dummy_master_mux_test2_grant <= dummy_master_mux_test2_masked_grant;
    end
  ...
  assign main_memory_stb_i = _switches_0_stb_i_T & _GEN[masterSelect][31:28] != 4'hF;
  ...
  assign led_matrix_0_stb_i =
    _switches_0_stb_i_T & _dat_r_cond_T_2 & _GEN[masterSelect] < 32'hF0000DAC;
  ...
  assign switches_0_stb_i =
    _switches_0_stb_i_T & _dat_r_cond_T_4 & _GEN[masterSelect] < 32'hF0000DB0;
