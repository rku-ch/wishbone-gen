...
module SharedBus(
  ...
  wire        masked_grant_1 = ~masked_grant_0 & cpu_instruction_interface_cyc_o;
  ...
  always @(posedge clock) begin
    ...
    if (|masked_grant_vec) begin
      cpu_data_interface_grant <= masked_grant_0;
      cpu_instruction_interface_grant <= masked_grant_1;
    end
    else if (|unmasked_grant_vec) begin
      cpu_data_interface_grant <= cpu_data_interface_cyc_o;
      cpu_instruction_interface_grant <= unmasked_grant_1;
    end
  ...
  assign main_memory_stb_i = cyc_validated_stb & adr[31:28] != 4'hF;
  ...
  assign led_matrix_0_stb_i =
    cyc_validated_stb & dat_r_lower_bound_1 & adr < 32'hF0000DAC;
  ...
  assign switches_0_stb_i = cyc_validated_stb & dat_r_lower_bound_2 & adr < 32'hF0000DB0;
